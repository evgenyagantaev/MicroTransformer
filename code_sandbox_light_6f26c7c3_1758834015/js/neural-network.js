...
class NeuralNetwork {
    constructor() {
        ...
        this.w1 = [
            [43.10627437, -38.55771652],    // Нейрон 1
            [-28.58474361,	-32.27193486],    // Нейрон 2
            [-5.838084166,	16.66146844],    // Нейрон 3
            [9.283024406,	30.55806591],    // Нейрон 4
            [4.05754434,	-20.79447504]            // Нейрон 5 
        ];
        
        // b1 - смещения для скрытого слоя (5x1)
        this.b1 = [
            43.96873155,   // Нейрон 1
            27.94661692,    // Нейрон 2  
            6.138264314,    // Нейрон 3
            33.47949113,   // Нейрон 4
            19.8617057         // Нейрон 5 
        ];
        
        // w2 - веса между скрытым и выходным слоем (1x5)
        // В изображении показано только 4 веса, добавляем пятый
        this.w2 = [0.147112147,	0.491435501,	-0.312110591,	-0.341011662,	0.040283592];
