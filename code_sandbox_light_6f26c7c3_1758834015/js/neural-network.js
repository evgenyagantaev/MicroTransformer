...
class NeuralNetwork {
    constructor() {
        ...
        this.w1 = [
            [-0.154932009, -1.163819304],    // Нейрон 1
            [-3.256234392,	3.449965077],    // Нейрон 2
            [-2.541648902,	5.24407333],    // Нейрон 3
            [4.983215282,	-1.08722545],    // Нейрон 4
            [-0.079327896,	-1.389041887]            // Нейрон 5 
        ];
        
        // b1 - смещения для скрытого слоя (5x1)
        this.b1 = [
            -1.467214484,   // Нейрон 1
            0.544119794,    // Нейрон 2  
            2.389789651,    // Нейрон 3
            -5.246619408,   // Нейрон 4
            0.523449737         // Нейрон 5 
        ];
        
        // w2 - веса между скрытым и выходным слоем (1x5)
        // В изображении показано только 4 веса, добавляем пятый
        this.w2 = [-0.589933994,	2.158873543,	-2.244271891,	1.828136028,	1.057937309];
